...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const googleFormActionUrl = 'https://docs.google.com/forms/d/e/1FAIpQLSd7G_eCoNZcXnr4MSKIGdaXr5B-tF13goY3q8nGzGHRJi8wrA/viewform?usp=pp_url';

    const formDataToSend = new FormData();
    formDataToSend.append('entry.{nameFieldId}', formData.name);
    formDataToSend.append('entry.{emailFieldId}', formData.email);
    formDataToSend.append('entry.{subjectFieldId}', formData.subject);
    formDataToSend.append('entry.{messageFieldId}', formData.message);
    ...
    <section id="contact" className="py-16 bg-white dark:bg-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form onSubmit={handleSubmit} className="max-w-lg mx-auto bg-gray-50 dark:bg-gray-700 p-8 rounded-lg shadow-lg" data-aos="fade-up">
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-blue-500 to-teal-600 dark:from-teal-600 dark:to-teal-700 text-white py-3 px-6 rounded-md hover:shadow-lg transition-transform transform hover:scale-105 duration-300"
            data-aos="fade-up"
          >
            Send Message
          </button>
